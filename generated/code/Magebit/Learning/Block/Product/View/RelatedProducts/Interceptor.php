<?php
namespace Magebit\Learning\Block\Product\View\RelatedProducts;

/**
 * Interceptor class for @see \Magebit\Learning\Block\Product\View\RelatedProducts
 */
class Interceptor extends \Magebit\Learning\Block\Product\View\RelatedProducts implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getRelatedProducts() : ?\Magento\Catalog\Model\ResourceModel\Product\Link\Product\Collection
    {
     ...
     * {@inheritdoc}
     */
    public function getProductUrls(\Magento\Catalog\Model\Product $product) : string
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductUrls');
        return $pluginInfo ? $this->___callPlugins('getProductUrls', func_get_args(), $pluginInfo) : parent::getProductUrls($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductImageUrl');
        return $pluginInfo ? $this->___callPlugins('getProductImageUrl', func_get_args(), $pluginInfo) : parent::getProductImageUrl($product);
    }

    /**
     * {@inheritdoc}
     */
    public function getProductName(\Magento\Catalog\Model\Product $product) : string
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductName');
        return $pluginInfo ? $this->___callPlugins('getProductName', func_get_args(), $pluginInfo) : parent::getProductName($product);
    }

    /**
     * {@inheritdoc}
     */
    public function getProductReviewsHtml(\Magento\Catalog\Model\Product $product) : string
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductReviewsHtml');
        return $pluginInfo ? $this->___callPlugins('getProductReviewsHtml', func_get_args(), $pluginInfo) : parent::getProductReviewsHtml($product);
    }

    /**
     * {@inheritdoc}
     */
    public function getPrice(\Magento\Catalog\Model\Product $product) : string
    {
     ...
     * {@inheritdoc}
     */
    public function addToCartUrl(\Magento\Catalog\Model\Product $product) : string
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addToCartUrl');
        return $pluginInfo ? $this->___callPlugins('addToCartUrl', func_get_args(), $pluginInfo) : parent::addToCartUrl($product);
    }
