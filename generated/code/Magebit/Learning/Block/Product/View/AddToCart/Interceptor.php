<?php
namespace Magebit\Learning\Block\Product\View\AddToCart;

/**
 * Interceptor class for @see \Magebit\Learning\Block\Product\View\AddToCart
 */
class Interceptor extends \Magebit\Learning\Block\Product\View\AddToCart implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductQty');
        return $pluginInfo ? $this->___callPlugins('getProductQty', func_get_args(), $pluginInfo) : parent::getProductQty();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductInStock');
        return $pluginInfo ? $this->___callPlugins('isProductInStock', func_get_args(), $pluginInfo) : parent::isProductInStock();
    }
